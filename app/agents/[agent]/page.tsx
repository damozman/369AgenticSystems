...
const AGENTS: Record<AgentSlug, AgentData> = {
  ...
  rex: {
    ...
    description: 'Rex is an autonomous outreach agent that activates the moment a new lead enters your system. He fires an email within 60 seconds of lead capture (SMS coming soon), then runs a multi-day follow-up sequence — day 0, day 3, day 7 — until the prospect books, opts out, or converts. He adapts his messaging to the vertical: storm alert emails for roofing, pre-season reminders for HVAC, renewal warnings for insurance. Rex turns your lead list from a static spreadsheet into an active pipeline that works while you sleep.',
    how: [
    ...
    deployments: [
      { vertical: 'Roofing',     label: 'Roofing',     role: 'Storm Alert Agent',     what: 'Fires email outreach to leads within 60 seconds of a storm-related call being captured (SMS coming soon).', color: '#FF4500', slug: 'roofing'     },
      ...
      { vertical: 'Plumbing',    label: 'Plumbing',    role: 'Emergency Follow-up',   what: 'Recovers missed emergency calls. Emails anyone who called and didn\'t get through within 2 minutes.', color: '#0369A1', slug: 'plumbing'    },
      ...
      { vertical: 'Real Estate', label: 'Real Estate', role: 'Speed-to-Lead',         what: 'Emails new buyer leads within 90 seconds of inquiry (SMS coming soon). Studies show first contact within 5 minutes increases conversion by 80%.', color: '#0EA5E9', slug: 'real-estate' },
      ...
      { vertical: 'Wholesale',   label: 'Wholesale',   role: 'Order Follow-up',       what: 'Confirms purchase orders via email, tracks reorder cycles, and fires reorder prompts when a customer goes quiet (SMS coming soon).', color: '#84CC16', slug: 'wholesale'   },
    ],
  ...
  nova: {
    ...
    how: [
      ...
      { step: 'Delivered immediately',  detail: 'The deliverable goes out via email within seconds of the trigger. The customer gets it while they\'re still thinking about the problem.' },
    ...
    deployments: [
      { vertical: 'Roofing',     label: 'Roofing',     role: 'Estimate Delivery',     what: 'Takes roof size, pitch, and damage description from the call — generates an estimate range and emails it to the homeowner within minutes (SMS coming soon).', color: '#FF4500', slug: 'roofing'     },
      ...
      { vertical: 'Plumbing',    label: 'Plumbing',    role: 'Quote Delivery',        what: 'Generates repair or replacement quotes based on the issue described on the call. Emails the quote while the customer is still deciding.', color: '#0369A1', slug: 'plumbing'    },
    ...
    tech: ['Claude API (document generation)', 'Resend (email delivery)', 'Twilio (SMS delivery — coming soon)', 'Supabase (log + state)', 'Vercel Functions (trigger handling)'],
  },
  ...
  felix: {
    ...
    how: [
      ...
      { step: 'Attorney notified',       detail: 'A conflict triggers an immediate email alert to the responsible attorney — before the consultation is scheduled. Clear intakes are auto-approved.' },
