...
const AGENTS: Record<AgentSlug, AgentData> = {
  ava: {
    ...
    deployments: [
      { vertical: 'Roofing',      label: 'Roofing',      role: 'Storm Call Capture',      what: 'Knows storm seasons, insurance claim language, and cash buyer vs. adjuster. Unique phone allocated in minutes.', color: '#FF4500', slug: 'roofing'      },
      ...
      { vertical: 'Plumbing',     label: 'Plumbing',     role: 'Emergency Recovery',      what: 'Answers 2 AM emergency calls. Knows average job values and routing. Allocated phone, live in minutes.', color: '#0369A1', slug: 'plumbing'     },
      { vertical: 'Legal',        label: 'Legal',        role: 'High-Value Intake',       what: 'Understands statute of limitations urgency. Screens case type and complexity. Phone allocated in minutes.', color: '#60A5FA', slug: 'legal'        },
      ...
      { vertical: 'Insurance',    label: 'Insurance',    role: 'Quote Intelligence',      what: 'Understands coverage gaps and upsell opportunities. Knows insurance terminology. Live in minutes.', color: '#14B8A6', slug: 'insurance'    },
      { vertical: 'Wholesale',    label: 'Wholesale',    role: 'Order Intelligence',      what: 'Captures order details and inventory urgency. Knows wholesale pricing and SKU routing. Live in minutes.', color: '#84CC16', slug: 'wholesale'    },
      { vertical: 'Dental',       label: 'Dental',       role: 'Appointment Booking',     what: 'Captures new patient inquiries and books appointments. Knows insurance questions and common patient concerns. Live in minutes.', color: '#EC4899', slug: 'dental'       },
    ],
  ...
  scout: {
    ...
    status:  'deploying',
    color:   '#8B5CF6',
    tagline: 'Qualifies trial users the moment they call. Gets the right info.',
    description: 'Scout is an agent that qualifies trial users during their first inbound call. The moment a trial signup call arrives, Scout asks the right discovery questions — company size, use case, team, timeline, budget — and captures the data that matters for onboarding. He asks like a sales engineer, not a chatbot. Every trial qualification is logged to your dashboard with structured fields, so your onboarding team knows exactly what to focus on during the trial. Scout is available on the Pro and Elite tiers.',
    how: [
