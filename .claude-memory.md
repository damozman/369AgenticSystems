...
| # | Industry | Landing URL | Source Tag |
|---|----------|------------|------------|
| 01 | Legal | `/legal/index.html` | `369AS_LEGAL_INTAKE` |
| 02 | Roofing | `/roofing-leads/index.html` | `369AS_ROOFING_INTAKE` |
| 03 | SaaS | `/saas/index.html` | `369AS_SAAS_INTAKE` |
| 04 | Dental | `/dental/index.html` | `369AS_DENTAL_INTAKE` |
| 05 | Real Estate | `/real-estate/index.html` | `369AS_REALESTATE_INTAKE` |
| 06 | Insurance | `/insurance/index.html` | `369AS_INSURANCE_INTAKE` |
| 07 | Wholesale | `/wholesale/index.html` | `369AS_WHOLESALE_INTAKE` |
| 08 | Custom | `/custom/index.html` | `369AS_UNLISTED_INTAKE` |
