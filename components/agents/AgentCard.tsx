...
const AGENT_CONFIGS: Record<AgentName, {
  ...
  rex: {
    name: 'Rex', defaultRole: 'Outreach + Follow-up', defaultVirtue: 'Never lets a lead go cold', defaultStatus: 'live',
    verticals: {
      original:      { role: 'Outreach + Follow-up',  virtue: 'Never lets a lead go cold',              status: 'live'      },
      ...
      legal:         { role: 'Lead Recovery Agent',    virtue: 'Follows up on every cold intake',        status: 'live'      },
      'real-estate': { role: 'Follow-up Specialist',   virtue: 'Follows up at day 0, 3, and 7',          status: 'live'      },
      insurance:     { role: 'Follow-up Specialist',   virtue: 'Follows up on every quote request',      status: 'live'      },
      saas:          { role: 'Follow-up Specialist',   virtue: 'Follows up on every demo request',       status: 'live'      },
      dental:        { role: 'Reactivation Agent',     virtue: 'Brings back lapsed patients',            status: 'future'    },
      wholesale:     { role: 'Follow-up Specialist',   virtue: 'Follows up on every order call',         status: 'live'      },
    },
  },
  nova: {
    name: 'Nova', defaultRole: 'Intelligence + Delivery', defaultVirtue: 'Handles the work nobody wants to do', defaultStatus: 'live',
    verticals: {
      original:      { role: 'Intelligence + Delivery', virtue: 'Handles the work nobody wants to do',   status: 'live'      },
      ...
      legal:         { role: 'Appointment Confirmation', virtue: 'Confirms every consultation instantly', status: 'live'      },
      'real-estate': { role: 'Showing Confirmation',      virtue: 'Confirms every showing automatically', status: 'live'      },
      insurance:     { role: 'Confirmation Specialist',   virtue: 'Confirms every booked call-back',      status: 'live'      },
      saas:          { role: 'Demo Confirmation',         virtue: 'Confirms every booked demo automatically', status: 'live'  },
      dental:        { role: 'Reminder Agent',           virtue: 'Reminders, confirms, no-show recovery', status: 'future'    },
      wholesale:     { role: 'Order Confirmation',        virtue: 'Confirms every order automatically',   status: 'live'      },
    },
  },
  felix: {
