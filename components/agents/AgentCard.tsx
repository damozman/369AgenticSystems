...
const AGENT_CONFIGS: Record<AgentName, {
  ...
  rex: {
    ...
    verticals: {
      ...
      'real-estate': { role: 'Follow-up Specialist',   virtue: 'Follows up at day 0, 3, and 7',          status: 'deploying' },
      insurance:     { role: 'Follow-up Specialist',   virtue: 'Follows up on every quote request',      status: 'deploying' },
      saas:          { role: 'Follow-up Specialist',   virtue: 'Follows up on every demo request',       status: 'deploying' },
      dental:        { role: 'Reactivation Agent',     virtue: 'Brings back lapsed patients',            status: 'future'    },
      wholesale:     { role: 'Follow-up Specialist',   virtue: 'Follows up on every order call',         status: 'deploying' },
    },
  },
  nova: {
    ...
    verticals: {
      ...
      legal:         { role: 'Appointment Confirmation', virtue: 'Confirms every consultation instantly', status: 'deploying' },
      'real-estate': { role: 'Showing Confirmation',      virtue: 'Confirms every showing automatically', status: 'deploying' },
      insurance:     { role: 'Confirmation Specialist',   virtue: 'Confirms every booked call-back',      status: 'deploying' },
      saas:          { role: 'Demo Confirmation',         virtue: 'Confirms every booked demo automatically', status: 'deploying' },
      dental:        { role: 'Reminder Agent',           virtue: 'Reminders, confirms, no-show recovery', status: 'future'    },
      wholesale:     { role: 'Order Confirmation',        virtue: 'Confirms every order automatically',   status: 'deploying' },
    },
  },
  felix: {
